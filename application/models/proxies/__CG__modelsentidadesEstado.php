 ...
 */
class Estado extends \models\entidades\Estado implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'uf', 'nome', 'enderecos', 'id'];
        }
     ...
     * {@inheritDoc}
     */
    public function addEnderecos(\models\entidades\Endereco $endereco)
    {
